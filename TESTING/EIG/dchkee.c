...
/* Main program */ int MAIN__(void)
{
    ...
    doublereal a[243936]	/* was [17424][14] */, b[87120]	/* was [17424]
	    ...
	    12] */;
#else
    doublereal * const a = malloc(243936 * sizeof(doublereal));
    doublereal * const b = malloc(87120 * sizeof(doublereal));
    doublereal * const c__ = malloc(160000 * sizeof(doublereal));
    doublereal * const d__ = malloc(1584 * sizeof(doublereal));
#endif
    integer i__, k;
    doublereal x[660];
    char c1[1], c3[3];
