...
/* Main program */ int MAIN__(void)
{
    ...
    real s[17424];
#else
    complex * const a = malloc(243936 * sizeof(complex));
    complex * const b = malloc(87120 * sizeof(complex));
    complex * const c__ = malloc(160000 * sizeof(complex));
    complex * const d__ = malloc(1584 * sizeof(complex));
    integer * const iwork = malloc(20064 * sizeof(integer));
    real * const rwork = malloc(89760 * sizeof(real));
    real * const s = malloc(17424 * sizeof(real));
#endif
    integer i__, k;
    complex x[660];
    char c1[1], c3[3];
