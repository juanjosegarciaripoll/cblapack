...
#else
    real * const a = malloc(243936 * sizeof(real));
    real * const b = malloc(87120 * sizeof(real));
    real * const c__ = malloc(160000 * sizeof(real));
    real * const d__ = malloc(1584 * sizeof(real));
#endif
    integer i__, k;
    real x[660];
    char c1[1], c3[3];
