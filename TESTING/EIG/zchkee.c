...
/* Main program */ int MAIN__(void)
{
...
#else
    doublecomplex * const a = malloc(243936 * sizeof(doublecomplex));
    doublecomplex * const b = malloc(87120 * sizeof(doublecomplex));
    doublecomplex * const c__ = malloc(160000 * sizeof(doublecomplex));
    doublecomplex * const d__ = malloc(1584 * sizeof(doublecomplex));
    doublereal * const s = malloc(17424 * sizeof(doublereal));
    integer * const iwork = malloc(20064 * sizeof(integer));
    doublereal * const rwork = malloc(89760 * sizeof(doublereal));
#endif
    integer i__, k;
    doublecomplex x[660];
    char c1[1], c3[3];
    ...
    char vname[32];
    integer inmin[20], newsd, nsval[20], inwin[20], nxval[20];
